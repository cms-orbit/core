...
return [
    ...
    */
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | This option controls the visibility of Orbit's built-in authentication pages.
     | If you wish to use your own authentication pages (e.g., with Laravel Jetstream),
     | you can disable Orbit's built-in authentication by setting this option to false.
     |
    ...
    /*
     ...
     | value is \Orbit\Attachment\Engines\Generator::class, but you can
    ...
    'icons' => [
        'bs'  => \CmsOrbit\Core\Support\BootstrapIconsPath::getFolder(),
    ],
    ...
    /*
     ...
     | Orbit will automatically generate its own 404 page.
    ...
    |
    | Options: 'settings::workspace.compact', 'settings::workspace.full'
    |
    */

    'workspace' => 'settings::workspace.compact',
    ...
    */
    ...
    /*
     ...
     | want to place Orbit's service provider in a location different from
     | "app/Orbit".
     |
     */
