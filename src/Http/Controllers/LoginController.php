...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $this->guard = $auth->guard(config('settings.guard'));
        ...
        if (InstalledVersions::satisfies(new VersionParser, 'laravel/framework', '>11.17.0')) {
            ...
            RedirectIfAuthenticated::redirectUsing(static fn () => route(config('settings.index')));
        }
    ...
    protected function sendLoginResponse(Request $request)
    {
        ...
        return $request->wantsJson()
            ...
            : redirect()->intended(route(config('settings.index')));
    }
    ...
    public function resetCookieLockMe(CookieJar $cookieJar)
    {
        ...
        return redirect()->route('settings.login')->withCookie($lockUser);
    }
