 ...
 * After update run: php artisan vendor:publish --provider="Orbit\Settings\Providers\FoundationServiceProvider".
 */
class FoundationServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(Dashboard::path('resources/views'), 'settings');
    ...
    {
        Event::listen(fn (\Laravel\Octane\Events\RequestReceived $request) => \CmsOrbit\Core\Support\Facades\Dashboard::flush());
