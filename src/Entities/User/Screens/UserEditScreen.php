...
use CmsOrbit\Core\Entities\User\Layouts\UserEditLayout;
use CmsOrbit\Core\Entities\User\Layouts\UserPasswordLayout;
use CmsOrbit\Core\Entities\User\Layouts\UserRoleLayout;
...
class UserEditScreen extends Screen
{
    ...
    public function commandBar(): iterable
    {
        ...
        if ($user->hasAccess('orbit.entities.users.impersonate')) {
            $commands[] = Button::make(__('Impersonate user'))
                ->icon('bg.box-arrow-in-right')
                ->confirm(__('You can revert to your original state by logging out.'))
                ->method('loginAs')
                ->canSee($this->user->exists && $this->user->id !== $user->id);
        }

        if ($user->hasAccess('orbit.entities.users.remove')) {
    ...
    public function save(User $user, Request $request)
    {
        ...
        return redirect()->route('orbit.entities.users');
    }
