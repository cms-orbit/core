...
abstract class Chart extends Layout
{
    ...
    /**
     * The React component key. Chart reuses the inherited `$type` property for
     * its own visual variant (bar/line/pie), so the layout type is fixed here
     * rather than derived from `$type`.
     */
    ...
    /**
     * Serialize the chart configuration and dataset to the React contract
     * consumed by the recharts-backed ChartLayout.
     *
