...
class Browsing extends Layout
{
    ...
    /**
     * Serialize the iframe configuration to the React contract. The React
     * BrowsingLayout reads `url` (the iframe src) and `title`; the remaining
     * iframe attributes are forwarded under `attributes`.
     *
