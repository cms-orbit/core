...
class StubPublishCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'orbit:stubs
     ...
     * @var string
     */
    protected $description = 'Publish the Orbit stubs that are available for customization';
    ...
    {
        $stubsPath = $this->laravel->basePath('stubs/orbit/platform');
