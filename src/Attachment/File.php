...
use CmsOrbit\Core\Attachment\Contracts\Engine;
use CmsOrbit\Core\Attachment\Engines\Generator;
use CmsOrbit\Core\Attachment\Models\Attachment;
use CmsOrbit\Core\Foundation\Events\ReplicateFileEvent;
use CmsOrbit\Core\Foundation\Events\UploadFileEvent;
...
class File
{
    ...
    private function getMatchesHash()
    {
        ...
        return Orbit::model(Attachment::class)::where('hash', $this->engine->hash())
