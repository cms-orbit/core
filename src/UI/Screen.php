...
use CmsOrbit\Core\Http\Controllers\Controller;
...
{
    use Commander, Concerns\HasFillablePublicProperties, Concerns\InteractsWithEncryptedState;
     ...
     *
     * @return iterable<\CmsOrbit\Core\Screen\Layout>|iterable<string>
     */
     ...
     *
     * @param \CmsOrbit\Core\Screen\Repository $repository
     *
     * @return View
     */
    ...
    public function asyncParticalLayout(Listener $layout, Request $request): Response
    {
        ...
        $view = $layout->build($repository).view('settings::partials.state', [
     ...
     * @throws \ReflectionException
     *
     * @return \CmsOrbit\Core\Screen\Repository
     */
